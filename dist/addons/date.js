...
export const DateFormatter = function (datePattern, dateMin, dateMax) {
    const that = this;
    that.date = [];
    that.blocks = [];
...
DateFormatter.prototype = {
    ...
    getValidatedDate: function (value) {
        ...
        that.blocks.forEach(function (length, index) {
            if (value.length > 0) {
                ...
                const sub0 = sub.slice(0, 1), rest = value.slice(length);
    ...
    getFixedDateString: function (value) {
        const that = this;
        const datePattern = that.datePattern;
        let date = [], dayIndex = 0, monthIndex = 0, yearIndex = 0, dayStartIndex = 0, monthStartIndex = 0, yearStartIndex = 0, fullYearDone = false, day, month, year;
        // mm-dd || dd-mm
        if (value.length === 4 &&
    ...
    getRangeFixedDate: function (date) {
        const that = this;
        const datePattern = that.datePattern, dateMin = that.dateMin || [], dateMax = that.dateMax || [];
